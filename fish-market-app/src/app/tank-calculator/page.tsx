...
const fishDatabase: Fish[] = [
  { _id: '1', name: 'Neon Tetra', category: 'community', careLevel: 'beginner', tankSize: '10 gallons', waterTemp: '72-78°F', waterPH: '6.0-7.0', schooling: true, groupSize: 6, price: 25, priceUnit: 'per_piece', availability: 'in_stock', image: '/fish-images/neon-tetra.jpg', description: 'Bright, colorful schooling fish' },
  { _id: '2', name: 'Betta Fish', category: 'solo', careLevel: 'beginner', tankSize: '5 gallons', waterTemp: '76-82°F', waterPH: '6.5-7.5', schooling: false, groupSize: 1, price: 150, priceUnit: 'per_piece', availability: 'in_stock', image: '/fish-images/betta-fish.jpg', description: 'Beautiful, vibrant fish' },
  { _id: '3', name: 'Angelfish', category: 'semi-aggressive', careLevel: 'intermediate', tankSize: '30 gallons', waterTemp: '75-82°F', waterPH: '6.0-7.5', schooling: false, groupSize: 1, price: 300, priceUnit: 'per_piece', availability: 'in_stock', image: '/fish-images/angelfish.jpg', description: 'Elegant cichlid' },
  { _id: '4', name: 'Guppy', category: 'community', careLevel: 'beginner', tankSize: '10 gallons', waterTemp: '72-82°F', waterPH: '7.0-8.5', schooling: true, groupSize: 3, price: 35, priceUnit: 'per_piece', availability: 'in_stock', image: '/fish-images/guppy.jpg', description: 'Colorful, hardy fish' },
  { _id: '5', name: 'Goldfish', category: 'coldwater', careLevel: 'beginner', tankSize: '20 gallons', waterTemp: '65-75°F', waterPH: '6.5-8.0', schooling: true, groupSize: 2, price: 80, priceUnit: 'per_piece', availability: 'in_stock', image: '/fish-images/goldfish.jpg', description: 'Classic aquarium fish' },
  { _id: '6', name: 'Discus', category: 'expert', careLevel: 'expert', tankSize: '50 gallons', waterTemp: '82-86°F', waterPH: '6.0-7.0', schooling: true, groupSize: 4, price: 1200, priceUnit: 'per_piece', availability: 'sold_out', image: '/fish-images/discus.jpg', description: 'King of freshwater fish' }
];
