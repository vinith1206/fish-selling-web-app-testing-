...
const WhatsAppButton = ({ className = '' }: { className?: string }) => {
  const handleWhatsAppClick = () => {
    const phoneNumber = '+916303220600';
    const message = 'mvs aqua';
  ...
  return (
    <button
      ...
      className={`bg-[#25D366] text-white p-4 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-110 animate-bounce-slow z-50 group ${className}`}
